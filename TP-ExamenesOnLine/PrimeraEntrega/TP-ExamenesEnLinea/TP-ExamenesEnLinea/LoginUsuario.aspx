    ...
    <div class="container">
        ...
        <div class="container" id="cont">
            <div class="nav nav-divider breadcrumb">
                <h3>
                    <i class="icon-user"></i>Acceso de Usuario</h3>
                <div class="breadcrumb col-md-7">
                    <div class="col-lg-10  col-md-10">
                        ...
                        <div class="controls">
                            ...
                            <br />
                    <%--    LINKS DE ACCESO RAPIDO ANTE LA FALTA DE CONEXION CON LA BASE DE DATOS--%>
                            <a href="AdminProfesor.aspx">[ENTRAR COMO PROFESOR]</a> <a href="EditarDatosAlumno.aspx">
        ...
        <div id="pie">
            <div class="modal-footer">
                Copyright 2013- Avellaneda Juliana, Vaccaro Cecilia</div>
        </div>
    </div>
</body>
</html>
